...
const documentActionCenterFiles = [
  ...
  },
  {
    ...
    patterns: [
      ...
      { name: 'session-gated preview panel integration', pattern: /PreviewSessionFrame/ },
  ...
  },
  {
    ...
    patterns: [
      ...
      { name: 'document preview session issuer', pattern: /issueDocumentPreviewSession/ },
      { name: 'header-gated document preview range fetcher', pattern: /fetchDocumentPreviewRange/ },
      { name: 'document preview session header', pattern: /x-amic-preview-session/ },
      { name: 'document preview token header', pattern: /x-amic-preview-token/ },
...
const enterpriseSearchFiles = [
  ...
  },
  {
    ...
    patterns: [
      ...
      {
        name: 'search result controlled preview route',
        pattern: /documentSearchHitUrlForSearchResult\(result, target\)/,
      },
...
const adminIntegrationsFiles = [
  {
    ...
    patterns: [
      ...
      { name: 'file organization scoped ops copy', pattern: /파일 정리 상태와 운영 확인/ },
