...
const CANONICAL_PAYLOAD_SHA256 = '53aba1870c253278e8284070b2680a42e5275d892b2fa30c6409292618e6f506';
  ...
  const packs = basePacks.map((pack) => {
    ...
    return {
      ...
      controlPlane: {
        ...
        candidateRollover: transitionTuwIds.length > 0 ? {
...
export function validateManifest(manifest) {
  ...
  for (const pack of packs) {
    ...
    const expectedCandidateRollover = expectedTransitionTuwIds.length > 0 ? {
      exactPaths: TRANSITION_CONTROL_PLANE_PATHS,
      mustFollowCandidateBookkeeping: true,
      mustPrecedeTransitions: true,
      preservesAcceptedEntryPrefix: true,
