...
| `/matters/[matterId]` | Matter workspace home. | Partial. Profile/team shell, matter-scoped file section, upload-triggered file-list refresh, governance context, Matter-scoped audit timeline, records links, and real-status work queue exist; unified task API remains incomplete. | DMS-UX-501 to 506 |
...
document list API. It must not expose check-out/check-in, Office live edit,
coauthoring, duplicate graphs, email/attachment relation graphs, or external
