...
| Saved searches/search folders | `saved_searches`, `GET/POST/DELETE /search/saved-searches` | Partial. User-scoped saved searches persist validated `SearchQueryDto` only and audit hash/filter refs. Virtual search folders remain a future information architecture layer. | DMS-UX-309 |
