...
> 기준: `origin/main@328ecbc9928bd52be1b9ab33b90405e1c7352523`
...
| 즐겨찾기 | New internal contract | production persistence/API 없음 | i18n label만 존재 | Pins decision → schema/API/UI 순서 |
...
| 3 | `PACK-DMS-WB-03` | personal Pins only | Pins decision record |
