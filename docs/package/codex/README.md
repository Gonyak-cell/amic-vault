...
3. **Codex에 "PACK-R0-01 진행"이라고 입력**한다 — Codex가 AGENTS.md §3.0 호출 규약에 따라 60번 문서의 해당 프롬프트를 스스로 읽고 실행한다(이후 PACK은 "다음 PACK 진행"). 시작점은 `CORE-REPOBUIL-CICD-TUW-001`(monorepo skeleton)이다.
