...
| DMS evidence     | Required state                                                                                                                                                                                                           | Evidence                                                                                                                                                           |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `EV-DMS-UI-004G` | Outlook filing path uses Matter Code suggestions, Matter upload/read permission, reference-only audit, hash-only redaction, and permitted Matter document links before any live Microsoft 365 tenant receipt is claimed. | `docs/release/enterprise-dms-ui-release-evidence.md`, Outlook service specs, matter suggestion integration tests, task pane tests, and Matter email timeline tests |
