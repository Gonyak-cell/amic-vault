...
| Local AI upload-prep queue       | active-full-release-file-org-prep | EV-LAI-PROD-005 / EV-LAI-PROD-006 / EV-LAI-PROD-007 / EV-LAI-PROD-008 / EV-LAI-PROD-009 / `AI_PREP_ENABLED=true` / `AI_PREP_QUEUE_WORKER_ENABLED=true` / `AI_PREP_REQUIRE_TENANT_ALLOWLIST=false` / `AI_SUMMARY_GEMMA_ENABLED=false`                 |
| Desktop native RC closeout       | staging-rc-pass; production-artifact-hold | EV-DESKTOP-010 / `docs/release/desktop-rc-closeout-1c7cba2.md` / PR #291 / GitHub Actions runs `27901847495`, `27901847504` / STAGE-SMOKE-AWS-DESKTOP-AUTH-1C7CBA2-2026-06-21 / STAGE-DMS-SYNTH-AWS-DESKTOP-1C7CBA2-2026-06-21 |
