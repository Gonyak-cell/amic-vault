...
| Local AI upload-prep queue       | active-canary-file-org-prep      | EV-LAI-PROD-005 / EV-LAI-PROD-006 / EV-LAI-PROD-007 / `AI_PREP_ENABLED=true` / `AI_PREP_QUEUE_WORKER_ENABLED=true` / `AI_SUMMARY_GEMMA_ENABLED=false`                                                                                              |
