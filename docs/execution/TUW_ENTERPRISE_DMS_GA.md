...
| PR-2A to PR-2C Document cabinet/detail        | DMS-GA-201, DMS-GA-202, DMS-GA-204, DMS-GA-205                         | PR-2A implemented on `codex/dms-ga2-cabinet-parity`; PR-2B implemented on `codex/dms-ga2-action-center`; PR-2C pending. | Matter cabinet parity, document action center, audit/activity timeline.                                                     |
