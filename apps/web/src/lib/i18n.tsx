...
const translations = {
  ...
  'nav.create': { ko: '새 사건', en: 'New matter' },
  ...
  'nav.group.governance': { ko: '거버넌스', en: 'Governance' },
  ...
  'nav.matters': { ko: '사건', en: 'Matters' },
  'nav.files': { ko: '파일', en: 'Files' },
  ...
  'files.page.description': {
    ...
    en: 'Only operationally confirmed data is shown until the files API is connected.',
  },
  'files.section.title': { ko: '파일 목록', en: 'File list' },
  'files.section.meta': { ko: '운영 데이터 미연결', en: 'Operational data not connected' },
  'files.empty.title': {
  ...
  'search.title': { ko: '파일 검색', en: 'Search files' },
  'search.label': { ko: '파일 검색', en: 'Search files' },
  'search.placeholder': {
    ko: '계약서, 사건, 키워드 검색',
  ...
  'matter.term': { ko: '사건', en: 'Matter' },
  'matter.list.title': { ko: '사건 목록', en: 'Matter list' },
  'matter.list.description': {
    ko: '접근 권한이 확인된 사건만 표시됩니다.',
    en: 'Only matters confirmed by access permissions are shown.',
  },
  'matter.list.scoped': { ko: '권한으로 보호됨', en: 'Permissions applied' },
  'matter.list.empty': { ko: '표시할 사건이 없습니다.', en: 'No matters to show.' },
  'matter.list.loading': { ko: '사건 목록을 불러오는 중입니다.', en: 'Loading matters.' },
  'matter.detail.fallbackTitle': { ko: '사건', en: 'Matter' },
  'matter.detail.descriptionLoading': {
    ko: '권한이 확인된 사건 정보만 표시됩니다.',
    en: 'Only matter details confirmed by access permissions are shown.',
  },
  'matter.detail.errorTitle': { ko: '사건을 표시할 수 없습니다.', en: 'Unable to display matter.' },
