...
const translations = {
  ...
  'route.blocked.cardMeta': { ko: '사용 제한', en: 'Production visibility blocked' },
  ...
  'search.facet.workProduct': { ko: '변호사 업무상 작성자료', en: 'Work product' },
  ...
  'search.facet.ocrLowConfidence': { ko: 'OCR 신뢰도 낮음', en: 'Low-confidence OCR' },
  'search.facet.documentHold': { ko: '문서 보존 조치', en: 'File hold' },
  'search.facet.matterHold': { ko: 'Matter 보존 조치', en: 'Matter hold' },
  ...
  'outlook.error.description': {
    ko: '계정 권한과 연결 상태를 확인해 주세요.',
    en: 'Check permissions or the status API connection.',
  },
  'outlook.gate.title': { ko: '운영 조건', en: 'Operational conditions' },
  'outlook.gate.meta': { ko: '연결 상태 기준', en: 'Connection status source' },
  'outlook.gate.enforced': { ko: '전송 제한', en: 'Send restriction' },
  'outlook.gate.rolloutRing': { ko: '적용 범위', en: 'Availability scope' },
  'outlook.gate.auditAvailability': { ko: '감사 기록', en: 'Audit records' },
  'outlook.status.enforced': { ko: '적용 중', en: 'Enforced' },
  'outlook.status.devMode': { ko: '확인 전', en: 'Not enforced' },
  ...
  'outlook.evidence.title': { ko: '연결 확인', en: 'Verification status' },
  'outlook.evidence.meta': { ko: '민감값 비노출', en: 'Sensitive values hidden' },
  'outlook.evidence.manifest': { ko: '앱 등록 확인', en: 'App registration check' },
  'outlook.evidence.graphConsent': { ko: 'Microsoft 권한 확인', en: 'Microsoft permission check' },
  'outlook.evidence.operatorApproval': { ko: '운영 승인', en: 'Operator approval' },
  'outlook.evidence.rollbackRehearsal': { ko: '비활성화 절차 확인', en: 'Disable procedure check' },
  ...
  'outlook.feature.graphAttachment': {
    ko: 'Microsoft 첨부 확인',
    en: 'Microsoft attachment access',
  },
  ...
  'outlook.reason.graphConsentMissing': {
    ko: 'Microsoft 권한 확인 필요',
    en: 'Microsoft permission check needed',
  },
