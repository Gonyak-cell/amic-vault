  ...
  const copy =
    language === 'ko'
      ? {
          ...
          denied: '접근 제한',
          failure: '실패',
          referencesTitle: '보안 운영 확인 정보',
          referencesDescription: '필요한 관리자만 감사 확인 정보를 열람합니다.',
          showReferences: '확인 정보 표시',
          hideReferences: '확인 정보 숨김',
          eventRef: '감사 이벤트 확인 정보',
          actorRef: '수행자 확인 정보',
          sessionRef: '세션 확인 정보',
          targetRef: '대상 확인 정보',
          matterRef: 'Matter 확인 정보',
          noReference: '확인 정보 없음',
          hiddenReference: '확인 정보 숨김',
        }
      : {
          title: 'Details',
