  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-4xl flex-col gap-5 px-6 py-6">
      <section className="flex items-start justify-between gap-4 border-b pb-4">
        <div>
          <p className="text-sm font-medium text-muted-foreground">{matter?.matterCode ?? params.matterId}</p>
          <h1 className="text-2xl font-semibold tracking-normal">{matter?.matterName ?? 'Matter'}</h1>
        </div>
