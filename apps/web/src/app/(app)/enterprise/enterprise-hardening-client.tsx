...
> = {
  ko: {
    ...
    compliance: '규정 준수',
    complianceMeta: '규정 준수 증빙 상태',
    dmsConfiguration: '문서 관리 설정',
    dmsConfigurationMeta: '분류 체계, 템플릿, 검색 조건 승인 상태',
    taxonomy: '문서 분류 체계',
    taxonomyMeta: '문서 유형, 세부 유형, 필수 문서 정보',
    templates: 'Matter 템플릿',
    templatesMeta: 'Matter 유형별 승인된 문서 세트',
    refiners: '검색 조건',
    refinersMeta: '검색 가능한 문서 정보 필드',
    taxonomySave: '분류 체계 저장',
    templateSave: '템플릿 저장',
    refinerSave: '검색 조건 저장',
    ...
    templateGate: '승인된 문서 세트만 Matter 화면에 표시',
    searchOps: '검색 색인 운영',
    searchOpsMeta: '재색인 요청 및 감사 기록',
    searchHealth: '검색 상태',
    searchHealthMeta: '검색 색인, 추출/OCR, 검색 기록 집계',
    currentVersions: '현재 버전',
    indexedVersions: '색인됨',
    missingIndex: '색인 누락',
    staleIndex: '색인 재처리 필요',
    extractionReady: '본문 검색 가능',
    extractionPending: '추출 대기',
    ocrPending: 'OCR 대기',
    extractionFailed: '추출 실패',
    staleChunks: '본문 조각 재생성 필요',
    staleEmbeddings: '검색 보강 정보 재생성 필요',
    queryAudit24h: '24시간 검색',
    noResultQueries24h: '24시간 무결과',
    p95SearchDuration: '검색 P95',
    noResultRefs: '결과 없음 검색 기록',
    queryHash: '검색 기록 확인 정보',
    category: '분류',
    reindexTenant: '전체 재색인 요청',
    reindexBusy: '요청 중',
    reindexAudit: '감사 기록 대상',
    reindexAccepted: '재색인 대기열 등록',
    reindexReady: '요청 전',
    contractRequired: '승인 필요',
    apiUnavailableTitle: '운영 데이터가 아직 연결되지 않았습니다.',
    apiUnavailableDescription: '연결 상태가 확인되면 이 섹션에 실제 설정 상태만 표시됩니다.',
    ...
    events: '이벤트',
    tables: '테이블',
    ssoProviders: '통합 로그인 제공자',
    keyReferences: '키 확인',
    siemExports: '보안 관제 내보내기',
    backupSnapshots: '스냅샷',
    complianceGaps: '규정 준수 미충족 항목',
    technicalCheck: '시스템 점검',
    opsHealth: '운영 상태',
    opsHealthMeta: '검색, 감사, 파일 정리 상태',
    opsHealthScope: '업로드 후 파일 정리 상태와 운영 확인이 필요한 항목만 표시됩니다.',
    opsRuntime: '파일 정리 상태',
    opsMetrics: '파일 정리 현황',
    opsReady: '정상',
    opsDegraded: '주의 필요',
  ...
  en: {
    ...
    opsHealthMeta: 'Search, audit, and file organization status',
    opsHealthScope:
      'This view shows only post-upload file organization status and items needing operational review.',
    opsRuntime: 'File organization status',
    opsMetrics: 'File organization summary',
    opsReady: 'Ready',
    ...
    prepFallback: 'Alternate processing',
      ...
      <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center">
        <div className="min-w-0">
          <p className="text-sm leading-6 text-muted-foreground">
            권한이 있는 운영자만 전체 검색 인덱스 재처리를 요청할 수 있습니다. 요청은 감사 기록과
            대기열 등록 수로만 확인합니다.
          </p>
