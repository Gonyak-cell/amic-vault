...
describe('document-lifecycle integration', () => {
  ...
  it('defers physical document and file-object deletes until a later records-disposal stage', () => {
    ...
    expect(readIfSmall('apps/api/src/modules/records/records-disposal.worker.ts')).toContain(
      'deleteSealedVersion',
    );
  });
});
