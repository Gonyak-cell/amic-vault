...
describe('audit shared types', () => {
  it('defines the R1 canonical action list while preserving R0 compatibility actions', () => {
    ...
    expect(r8ContractAuditActions).toContain('CONTRACT_AI_REVIEW_REQUESTED');
    expect(r8ContractAuditActions).toContain('CONTRACT_NEGOTIATION_ISSUES_EXPORTED');
    expect(r9DdAuditActions).toContain('DD_TRACE_VIEWED');
    expect(r9DdAuditActions).toContain('DD_REPORT_EXPORTED');
  ...
  it('keeps metadata keys restricted to reference-like values', () => {
    const metadata = {
      ...
      item_code: 'legal_hold_clear',
      dlp_alert_id: '11111111-1111-4111-8111-111111111155',
      download_byte_count: 524288000,
      threshold_event_count: 50,
      threshold_byte_count: 524288000,
      window_start: '2026-07-04T00:00:00.000Z',
      window_end: '2026-07-04T01:00:00.000Z',
      pending_count: 1,
      passed_count: 3,
      waived_count: 1,
      pending_items: ['legal_hold_clear'],
      related_matter_id: '11111111-1111-4111-8111-111111111212',
      ...
      work_kind: 'contract_review_stage',
      assignee_scope: 'user',
      ...
      closing_binder_id: '11111111-1111-4111-8111-111111111215',
